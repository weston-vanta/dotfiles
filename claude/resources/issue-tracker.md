...
- **Project key**: `COL`
- **Parent epic**: `COL-5671` ([browse](https://vanta.atlassian.net/browse/COL-5671))
...
Create a Jira issue in project `COL`, parented to `COL-5671`, using `acli jira`. The issue title and body come from the skill; the project and parent come from this file.
